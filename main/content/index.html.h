...
"        </label>"
""
"        <div id=\"releaseStatus\" class=\"muted\">Geen release geselecteerd</div>"
""
""
"      </section>"
...
""
"  if (!repo) { status.textContent = \"Geen release geselecteerd\"; return; }"
""
...
"    if (msg === \"Failed to fetch\") msg = \"Netwerkfout (GitHub API onbereikbaar).\";"
"    status.textContent = `Fout: ${msg}`;"
"  }"
"}"
