...
"<input type=\"text\" id=\"repo\" name=\"repo\" placeholder=\"AchimPieters/esp32-test\" />"
"</div>"
"<div class=\"field token\">"
"<label>GitHub token (optional)</label>"
"<input name=\"token\" type=\"password\" placeholder=\"ghp_... or classic token\" autocomplete=\"off\" />"
"<small>Used to avoid rate limits and access private releases.</small>"
"</div>"
"<div class=\"field prerelease\">"
"<label><input type=\"checkbox\" id=\"prerelease\" name=\"prerelease\" value=\"1\" /> Pre-release toestaan</label>"
"</div>"
