...
"<label for=\"repo\">Firmware repository:</label>"
"<input type=\"text\" id=\"repo\" name=\"repo\" placeholder=\"owner/repo\" />"
"</div>"
"<div class=\"field\">"
"<label><input type=\"checkbox\" id=\"prerelease\" name=\"prerelease\" /> Use pre-release</label>"
"</div>"
"<div class=\"field\">"
"<label for=\"bin_url\">main.bin URL:</label>"
"<input type=\"text\" id=\"bin_url\" name=\"bin_url\" readonly />"
"</div>"
"<div class=\"field\">"
"<label for=\"sig_url\">main.bin.sig URL:</label>"
"<input type=\"text\" id=\"sig_url\" name=\"sig_url\" readonly />"
"</div>"
...
"const prerelease_cb = document.getElementById('prerelease');"
"const bin_url_field = document.getElementById('bin_url');"
"const sig_url_field = document.getElementById('sig_url');"
"function enable(el) {"
"el.disabled = false;"
"}"
"function disable(el) {"
...
"const repo = repo_field.value.trim();"
"if (!repo) {"
"bin_url_field.value = '';"
"sig_url_field.value = '';"
"return;"
"}"
"const api = prerelease_cb.checked ?"
...
"const release = prerelease_cb.checked ? data[0] : data;"
"const assets = release.assets || [];"
"const binAsset = assets.find(a => a.name === 'main.bin');"
"const sigAsset = assets.find(a => a.name === 'main.bin.sig');"
"bin_url_field.value = binAsset ? binAsset.browser_download_url : '';"
"sig_url_field.value = sigAsset ? sigAsset.browser_download_url : '';"
"} catch (e) {"
"bin_url_field.value = '';"
"sig_url_field.value = '';"
"}"
...
"};"
"});"
"repo_field.addEventListener('change', updateUrls);"
"prerelease_cb.addEventListener('change', updateUrls);"
"</script>"
"</body>"
"</html>";
